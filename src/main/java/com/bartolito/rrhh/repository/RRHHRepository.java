...
public class RRHHRepository {
	...
	public int editarHorarioDetalle(Integer codiHoraDeta, Integer codiHora, Integer codiTurn, Integer anulTurn,
			Integer usuamodi) {
	...
	public List<Map<String, Object>> reporteAsistenciaMensual(String fechaInicio, String fechaFin, int codiServ) {
		...
		// JdbcTemplate mapeará las columnas de fechas (2025-12-01, etc.)
		// automáticamente al Map
		return sigoldJdbc.queryForList(sql, fechaInicio, fechaFin, codiServ);
	}
