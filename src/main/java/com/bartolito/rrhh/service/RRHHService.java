...
public class RRHHService {
    ...
    public List<Map<String, Object>> listarProgramacionMensual(
            String inicio, String fin, int codiServ) {

        List<Map<String, Object>> data =
                repository.listarProgramacionMensual(inicio, fin, codiServ);
    ...
    public List<Map<String, Object>> reporteResumenDiarioServicio(String fechaInicio,String fechaFin,Integer codiServ) {
   ...
   ========================= */
    ...
    public Map<String, Object> seleccionarEmpresaPorCodigo(int codiEmpr) {
        ...
        if (results.isEmpty()) {
            throw new NoSuchElementException(
                    "La Empresa con código " + codiEmpr + " no fue encontrada."
            );
        }
        return results.get(0);
    }
    ...
    public int agregarEmpresa(
        ...
        return repository.agregarEmpresa(
                nombEmpr,
    ...
    public void modificarEmpresa(
        ...
        int filas = repository.modificarEmpresa(
                codiEmpr,
                nombEmpr,
